...
def ecrire(text: str, vitesse = vitesse_text) -> None:
    """
...
# Arriver à la porte
ecrire("Vous arrivez à la porte, vous décidez de la franchir\n")
...
""")
    R = question("""Ils vous faut choisir :
...
""")
        ...
        #Branche 1.3.2
        ecrire("""Vous traversez cette grande allée et observez autour de vous 
...
Votre réponse : """,("1","2"))
    ...
    if R == "1" :
        ecrire("""
Vous lancez une pierre vers l'insecte, il perd l'équilibre de son vole et s'écrase au sol
